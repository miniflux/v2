...
create index document_vectors_idx on entries using gin(document_vectors);`,
	...
	"schema_version_24": `alter table feeds add column default_read boolean default 'f';
`,
...
var SqlMapChecksums = map[string]string{
	...
	"schema_version_24": "f63e818771ba2954827580dfa36be915561bebaa6d01fdcc138626bf5819cf10",
