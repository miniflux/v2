...
var translations = map[string]string{
    ...
    "menu.show_all_entries": "Alle Einträge",
    "menu.show_only_unread_entries": "Ungelesene Einträge",
    "menu.show_only_starred_entries": "Markierte Einträge",
    ...
    "page.stat.title": "Miniflux Reader",
    "page.stat.articles": "Artikel",
    "page.stat.articles.unread": "Ungelesene Artikel",
    "page.stat.articles.starred": "Markierte Artikel",
    "page.stat.categories.unread": "Ungelesen nach Kategorien",
    "page.stat.categories.starred": "Markiert nach Kategorien",
    "page.stat.feeds.unread": "Ungelesen von Feeds",
    "page.stat.feeds.starred": "Markiert von Feeds",
    ...
    "alert.no_unread_category_entry": "Es gibt keine ungelesenen Artikel in dieser Kategorie.",
    "alert.no_starred_category_entry": "Es gibt keine markierten Artikel in dieser Kategorie.",
...
`,
    ...
    "menu.show_all_entries": "All entries",
    "menu.show_only_unread_entries": "Unread entries",
    "menu.show_only_starred_entries": "Starred entries",
    ...
    "page.stat.title": "Miniflux Reader",
    "page.stat.articles": "Articles",
    "page.stat.articles.unread": "Unread Articles",
    "page.stat.articles.starred": "Starred Articles",
    "page.stat.categories.unread": "Unread by Categories",
    "page.stat.categories.starred": "Starred by Categories",
    "page.stat.feeds.unread": "Unread by Feeds",
    "page.stat.feeds.starred": "Starred by Feeds",
    ...
    "alert.no_unread_category_entry": "There are no unread articles in this category.",
    "alert.no_starred_category_entry": "There are no starred articles in this category.",
...
`,
    ...
    "menu.show_all_entries": "Todas las entradas",
    "menu.show_only_unread_entries": "Entradas no leídas",
    "menu.show_only_starred_entries": "Entradas destacadas",
    ...
    "page.stat.title": "Lector Miniflux",
    "page.stat.articles": "Artículos",
    "page.stat.articles.unread": "Artículos no leídos",
    "page.stat.articles.starred": "Artículos destacados",
    "page.stat.categories.unread": "No leído por categorías",
    "page.stat.categories.starred": "Destacado por categorías",
    "page.stat.feeds.unread": "No leído por feeds",
    "page.stat.feeds.starred": "Destacado por feeds",
    ...
    "alert.no_unread_category_entry": "No hay artículos no leídos en esta categoría.",
    "alert.no_starred_category_entry": "No hay artículos destacados en esta categoría.",
...
`,
    ...
    "menu.show_all_entries": "Toutes les entrées",
    "menu.show_only_unread_entries": "Entrées non lues",
    "menu.show_only_starred_entries": "Entrées marquées",
    ...
    "page.stat.title": "Miniflux Reader",
    "page.stat.articles": "Des articles",
    "page.stat.articles.unread": "Articles non lus",
    "page.stat.articles.starred": "Articles favoris",
    "page.stat.categories.unread": "Non lu par catégories",
    "page.stat.categories.starred": "Favoris par catégories",
    "page.stat.feeds.unread": "Non lu par les flux",
    "page.stat.feeds.starred": "Starred By Feeds",
    ...
    "alert.no_unread_category_entry": "Il n'y a pas d'articles non lus dans cette catégorie.",
    "alert.no_starred_category_entry": "Il n'y a pas d'articles favoris dans cette catégorie.",
...
`,
    ...
    "menu.show_all_entries": "Tutte le voci",
    "menu.show_only_unread_entries": "Voci non lette",
    "menu.show_only_starred_entries": "Voci speciali",
    ...
    "page.stat.title": "Lettore Miniflux",
    "page.stat.articles": "articoli",
    "page.stat.articles.unread": "Articoli non letti",
    "page.stat.articles.starred": "Articoli speciali",
    "page.stat.categories.unread": "Non letto per categorie",
    "page.stat.categories.starred": "Speciali per categorie",
    "page.stat.feeds.unread": "Non letto dai feed",
    "page.stat.feeds.starred": "Protetto da feed",
    ...
    "alert.no_unread_category_entry": "Non ci sono articoli non letti in questa categoria.",
    "alert.no_starred_category_entry": "Non ci sono articoli speciali in questa categoria.",
...
`,
    ...
    "menu.show_all_entries": "Alle inschrijvingen",
    "menu.show_only_unread_entries": "Ongelezen vermeldingen",
    "menu.show_only_starred_entries": "Met ster ingevoerde gegevens",
    ...
    "page.stat.title": "Miniflux-lezer",
    "page.stat.articles": "artikelen",
    "page.stat.articles.unread": "Ongelezen artikelen",
    "page.stat.articles.starred": "Artikelen met ster",
    "page.stat.categories.unread": "Ongelezen op categorieën",
    "page.stat.categories.starred": "Met ster door categorieën",
    "page.stat.feeds.unread": "Ongelezen door feeds",
    "page.stat.feeds.starred": "Met ster door feeds",
    ...
    "alert.no_unread_category_entry": "Er zijn geen ongelezen artikelen in deze categorie.",
    "alert.no_starred_category_entry": "Er zijn geen artikelen met ster in deze categorie.",
...
`,
    ...
    "menu.show_all_entries": "Wszystkie wpisy",
    "menu.show_only_unread_entries": "Nieprzeczytane wpisy",
    "menu.show_only_starred_entries": "Wpisy oznaczone gwiazdką",
    ...
    "page.stat.title": "Czytnik Miniflux",
    "page.stat.articles": "Artykuły",
    "page.stat.articles.unread": "Nieprzeczytane artykuły",
    "page.stat.articles.starred": "Artykuły oznaczone gwiazdką",
    "page.stat.categories.unread": "Nieprzeczytane według kategorii",
    "page.stat.categories.starred": "Oznaczone gwiazdką według kategorii",
    "page.stat.feeds.unread": "Nieprzeczytane przez kanały",
    "page.stat.feeds.starred": "Oznaczone gwiazdką według kanałów",
    ...
    "alert.no_unread_category_entry": "W tej kategorii nie ma nieprzeczytanych artykułów.",
    "alert.no_starred_category_entry": "W tej kategorii nie ma artykułów oznaczonych gwiazdką.",
...
`,
    ...
    "menu.show_all_entries": "Все записи",
    "menu.show_only_unread_entries": "Непрочитанные записи",
    "menu.show_only_starred_entries": "Помеченные записи",
    ...
    "page.stat.title": "Miniflux Reader",
    "page.stat.articles": "статьи",
    "page.stat.articles.unread": "Непрочитанные статьи",
    "page.stat.articles.starred": "Помеченные статьи",
    "page.stat.categories.unread": "Непрочитано по категориям",
    "page.stat.categories.starred": "Помечено по категориям",
    "page.stat.feeds.unread": "Непрочитано по каналам",
    "page.stat.feeds.starred": "Помечено Feeds",
    ...
    "alert.no_unread_category_entry": "В этой категории нет непрочитанных статей.",
    "alert.no_starred_category_entry": "В этой категории нет помеченных статей.",
...
`,
    ...
    "menu.show_all_entries": "所有文章",
    "menu.show_only_unread_entries": "未读文章",
    "menu.show_only_starred_entries": "星标文章",
    ...
    "page.stat.title": "Miniflux 阅读器",
    "page.stat.articles": "文章",
    "page.stat.articles.unread": "未读文章",
    "page.stat.articles.starred": "星标文章",
    "page.stat.categories.unread": "未读分类文章",
    "page.stat.categories.starred": "星标分类文章",
    "page.stat.feeds.unread": "未读订阅文章",
    "page.stat.feeds.starred": "星标订阅文章",
    ...
    "alert.no_unread_category_entry": "该分类下没有未读文章",
    "alert.no_starred_category_entry": "该分类下没有星标文章",
    "alert.no_feed_entry": "该源中没有文章",
    "alert.no_unread_feed_entry": "该源中没有未读文章",
    "alert.no_starred_feed_entry": "该源中没有星标文章",
...
var translationsChecksums = map[string]string{
	"de_DE": "94264bc37b55ecb8bb6b91d57011b93cdd07201d5bedf1b7e59f8b8b68bdbdf3",
	"en_US": "e63cca83a60add097b58e5e37e2c21d37e1d91390fdcdbfea803e9a4168a591d",
	"es_ES": "4b52032240057c6d1d219d3ed8d8719ca7ea61dbf6c06ecd1b354166f945ff36",
	"fr_FR": "5a3e2208e0aaa11600f0952791746e8273724c0fe4754edb1d31eecff568600b",
	"it_IT": "bf0c23d047738bbea0de574eedd8f2f3fd2ba7dc70b77acf2ac68005a005ef6e",
	"nl_NL": "9ece2ba9457641372cf4c1631345c8da5effd12c69eab0e74333d02548546aca",
	"pl_PL": "c76671c6e821e9c2f73ddf7ededff59404551d584ccffad5aad229a2af15d9f5",
	"ru_RU": "5ee81e9d8359a54a264be6d229148c7ffca0623df7d29162791dcc130c8ddb40",
	"zh_CN": "5a9664e5fe8ecaaf62dd9d25650ab0063b729791d2f17e188daaad84045ce7a9",
}
