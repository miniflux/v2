...
var translations = map[string]string{
    ...
    "page.edit_feed.next_check": "Nächste Überprüfung:",
    "page.edit_feed.next_check_note": "Vorbehaltlich globaler Optionen POLLING FREQUENCY und BATCH_SIZE",
    ...
    "page.edit_feed.next_check": "Next check:",
    "page.edit_feed.next_check_note": "Subject to global options POLLING_FREQUENCY and BATCH_SIZE",
    ...
    "page.edit_feed.next_check": "Siguiente comprobación:",
    "page.edit_feed.next_check_note": "Sujeto a opciones globales POLLING FREQUENCY y BATCH_SIZE",
    ...
    "page.edit_feed.next_check": "Prochaine vérification :",
    "page.edit_feed.next_check_note": "Sous réserve des options globales POLLING FREQUENCY et BATCH_SIZE",
    ...
    "page.edit_feed.next_check": "Prossimo controllo:",
    "page.edit_feed.next_check_note": "Soggetto alle opzioni globali POLLING FREQUENCY e BATCH_SIZE",
    ...
    "page.edit_feed.next_check": "次のチェック:",
    "page.edit_feed.next_check_note": "グローバルオプションPOLLINGFREQUENCYおよびBATCH_SIZEに従います",
    ...
    "page.edit_feed.next_check": "Volgende controle:",
    "page.edit_feed.next_check_note": "Onderworpen aan globale opties POLLING FREQUENCY en BATCH_SIZE",
    "page.edit_feed.last_modified_header": "LastModified-header:",
    "page.edit_feed.etag_header": "ETAG-header:",
    ...
    "page.edit_feed.next_check": "Następna kontrola:",
    "page.edit_feed.next_check_note": "Z zastrzeżeniem opcji globalnych POLLING FREQUENCY i BATCH_SIZE",
    ...
    "page.edit_feed.next_check": "Próxima verificação:",
    "page.edit_feed.next_check_note": "Sujeito às opções globais POLLING FREQUENCY e BATCH_SIZE",
    ...
    "page.edit_feed.next_check": "Следующая проверка:",
    "page.edit_feed.next_check_note": "В соответствии с глобальными параметрами POLLING FREQUENCY и BATCH_SIZE",
    ...
    "page.edit_feed.next_check": "下次检查时间:",
    "page.edit_feed.next_check_note": "取决于全局选项POLLING FREQUENCY和BATCH_SIZE",
...
var translationsChecksums = map[string]string{
	"de_DE": "507d7c5092a67209e6dc6d897be28259d99903ae5d1b40070a11e49f392d6aab",
	"en_US": "68c2ae90d4cedb70e3bf63f761f42aadef671b0cd8ae5431a9cd86470f563a20",
	"es_ES": "2be99a2e28dd0478e4007579b8d5a1d389987db2eb8e01d27e639297199175be",
	"fr_FR": "2be82cab900e0567b0a7f3673eb550015ee96eebee09267d8cb5f0decf562f62",
	"it_IT": "d8cf116f042c27199241ef0d92981df41418c65c48612a1ef7f99ff392c4e79a",
	"ja_JP": "9c3b258d6846f1c7e3cd6b257bfca898f95ffb932e45d3cd69ebae1c23f2d33b",
	"nl_NL": "451bb2e1950839a07c3ef410ed9e47aa06d6ecb6f1477b026776884f935dcb4b",
	"pl_PL": "e8ebfe90f2ef82ab6be45d54618f06c8cf3984b8cf7959f926d45304f45e7845",
	"pt_BR": "8f329fad1fe82da558c4bee450a561614d587c9c6663f52ee27815ee3d84cd72",
	"ru_RU": "ea9cfe066762a7fd5844c13092ce41bd7530984dfc02a04c0b0ddb6d4db8d996",
	"zh_CN": "86ece0f1c333f5a69ee561b67330d4742c0f2f1eb2ec3b2c337237fdbde6aa25",
}
