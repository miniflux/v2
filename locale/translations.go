...
var translations = map[string]string{
    ...
    "menu.show_only_read_entries": "Nur gelesene Artikel anzeigen",
    ...
    "menu.sort_feeds_sort": "Sortierung",
    "menu.sort_feeds_name": "Name",
    "menu.sort_feeds_published": "Zeitpunkt der Veröffentlichung",
    "menu.sort_feeds_last_check": "Letzte Aktualisierung",
    "menu.sort_feeds_unread": "Ungelesene Artikel",
    "menu.sort_feeds_read": "Gelesene Artikel",
    "menu.sort_feeds_total": "Gesamte Artikel",
    "search.label": "Suche",
...
`,
    ...
    "menu.show_only_read_entries": "Show only read entries",
    ...
    "menu.sort_feeds_name": "name",
    "menu.sort_feeds_published": "last post",
    "menu.sort_feeds_last_check": "last check",
    "menu.sort_feeds_unread": "unread",
    "menu.sort_feeds_read": "read",
...
`,
    ...
    "menu.show_only_read_entries": "Mostrar solo las entradas leídas",
    ...
    "menu.sort_feeds_sort": "Clasificación",
    "menu.sort_feeds_name": "nombre",
    "menu.sort_feeds_published": "tiempo publicado",
    "menu.sort_feeds_last_check": "Última verificación",
    "menu.sort_feeds_unread": "no leídas",
    "menu.sort_feeds_read": "leídas",
    "menu.sort_feeds_total": "totales",
    "search.label": "Buscar",
...
`,
    ...
    "menu.show_only_read_entries": "Afficher uniquement les articles lus",
    ...
    "menu.sort_feeds_name": "nom",
    "menu.sort_feeds_published": "date de publication",
    "menu.sort_feeds_last_check": "date de mise à jour",
    "menu.sort_feeds_unread": "non lu",
    "menu.sort_feeds_read": "lu",
    "menu.sort_feeds_total": "total",
...
`,
    ...
    "menu.show_only_read_entries": "Mostra solo voci lette",
    ...
    "menu.sort_feeds_name": "nome",
    "menu.sort_feeds_published": "data di pubblicazione",
    "menu.sort_feeds_last_check": "data aggiornamento",
    "menu.sort_feeds_unread": "non lette",
    "menu.sort_feeds_read": "lette",
    "menu.sort_feeds_total": "totali",
    "search.label": "Cerca",
...
`,
    ...
    "menu.show_only_read_entries": "既読の記事だけを表示",
    ...
    "menu.sort_feeds_name": "名前",
    "menu.sort_feeds_published": "公開時間",
    "menu.sort_feeds_last_check": "最終チェック",
    "menu.sort_feeds_unread": "未読",
    "menu.sort_feeds_read": "既読",
    "menu.sort_feeds_total": "合計",
    "search.label": "検索",
    ...
    "entry.scraper.label": "オリジナルの内容を取得",
...
`,
    ...
    "menu.show_only_read_entries": "Toon alleen gelezen artikelen",
    ...
    "menu.sort_feeds_sort": "Volgorde",
    "menu.sort_feeds_name": "naam",
    "menu.sort_feeds_published": "gepubliceerde tijd",
    "menu.sort_feeds_last_check": "Laatste update",
    "menu.sort_feeds_unread": "ongelezen",
    "menu.sort_feeds_read": "gelezen",
...
`,
    ...
    "menu.show_only_read_entries": "Pokaż tylko przeczytane artykuły",
    ...
    "menu.sort_feeds_sort": "Sortowanie",
    "menu.sort_feeds_name": "nazwa",
    "menu.sort_feeds_published": "opublikowany czas",
    "menu.sort_feeds_last_check": "Ostatnia aktualizacja",
    "menu.sort_feeds_unread": "nieprzeczytanych",
    "menu.sort_feeds_read": "przeczytanych",
    "menu.sort_feeds_total": "wszystkich",
    "search.label": "Szukaj",
...
`,
    ...
    "menu.show_only_read_entries": "Показывать только прочитанные статьи",
    ...
    "menu.sort_feeds_sort": "Сортировка",
    "menu.sort_feeds_name": "имя",
    "menu.sort_feeds_published": "опубликованное время",
    "menu.sort_feeds_last_check": "Последняя проверка",
    "menu.sort_feeds_unread": "непрочитанных",
    "menu.sort_feeds_read": "прочитанных",
    "menu.sort_feeds_total": "общих",
    "search.label": "Поиск",
...
`,
    ...
    "menu.show_only_read_entries": "仅显示已读文章",
    "menu.refresh_feed": "更新",
    ...
    "menu.sort_feeds_name": "名称",
    "menu.sort_feeds_published": "发布时间",
    "menu.sort_feeds_last_check": "最后检查时间",
    "menu.sort_feeds_unread": "未读",
    "menu.sort_feeds_read": "已读",
    "menu.sort_feeds_total": "总条目数",
    "search.label": "搜索",
...
var translationsChecksums = map[string]string{
	"de_DE": "1ea69f923235162ad65bdf385135064a2ea92c2f5bdd7b0927442417d80fe358",
	"en_US": "579e5209f2a82dd39d3695e7c3063ee3f56dbb6955dee17227f9375ab0661af1",
	"es_ES": "77bd8cf880716d80a1fc00f432ae18f2597e9009f5b4baf0ce85fa3fad56c5ef",
	"fr_FR": "a7656e9fd0d00db750f873f54c69126b96c068b836875b873d97080941f12eaf",
	"it_IT": "0dac231607d1da701f896cf37f81e2e2606fb2694415a547dbd4f4d7e6d83dde",
	"ja_JP": "1e26accdd7df4183b6d4c0678599c3a538ede04a4fcfe28b54f7377add98b118",
	"nl_NL": "4e37f01324d5a10822b3fdc764251acdeff53869905465d46d0760512e0a24e7",
	"pl_PL": "0625cb4b6be0b599b446a3006a32e1c86d0bfe26438a9284c5d707a984710c79",
	"ru_RU": "d2faa2aa69165378df7799ed1a1fea9adc7e93fcb54fc25a792589f928197ce5",
	"zh_CN": "c8e30750a21c1bc57a5642de8fc00ae0af5b2f1025c2714fa16f8f312562aecc",
}
