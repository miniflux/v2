...
var translations = map[string]string{
    ...
    "menu.sort_feeds_sort": "Sortiert nach",
    "menu.sort_feeds_disabled": "Behindert",
    "menu.sort_feeds_errors": "Fehler",
    "menu.sort_feeds_title": "Titel",
    "menu.sort_feeds_total": "Gesamt",
    "menu.sort_feeds_unread": "Ungelesen",
    "search.label": "Suche",
    ...
    "form.prefs.label.feed_sorted_by": "Feed sortiert nach",
    "form.prefs.label.feed_direction": "Feed-Sortierrichtung",
    "form.prefs.select.feed_sorted_by_disabled": "Behindert",
    "form.prefs.select.feed_sorted_by_error": "Fehleranzahl",
    "form.prefs.select.feed_sorted_by_title": "Titel",
    "form.prefs.select.feed_sorted_by_total_count": "Einträge insgesamt",
    "form.prefs.select.feed_sorted_by_unread_count": "Ungelesene Einträge",
    "form.prefs.select.feed_direction_asc": "Aufsteigend",
    "form.prefs.select.feed_direction_desc": "Absteigend",
    ...
    "menu.sort_feeds_sort": "Sort by",
    "menu.sort_feeds_disabled": "Disabled",
    "menu.sort_feeds_errors": "Errors",
    "menu.sort_feeds_title": "Title",
    "menu.sort_feeds_total": "Total",
    "menu.sort_feeds_unread": "Unread",
    "search.label": "Search",
    ...
    "form.prefs.label.feed_sorted_by": "Feed sorted by",
    "form.prefs.label.feed_direction": "Feed sorting direction",
    "form.prefs.select.feed_sorted_by_disabled": "Disabled",
    "form.prefs.select.feed_sorted_by_error": "Error count",
    "form.prefs.select.feed_sorted_by_title": "Title",
    "form.prefs.select.feed_sorted_by_total_count": "Total entries",
    "form.prefs.select.feed_sorted_by_unread_count": "Unread entries",
    "form.prefs.select.feed_direction_asc": "Ascending",
    "form.prefs.select.feed_direction_desc": "Descending",
    ...
    "menu.sort_feeds_sort": "Ordenado por",
    "menu.sort_feeds_disabled": "Discapacitado",
    "menu.sort_feeds_errors": "Errores",
    "menu.sort_feeds_title": "Título",
    "menu.sort_feeds_total": "Total",
    "menu.sort_feeds_unread": "No leído",
    "search.label": "Buscar",
    ...
    "form.prefs.label.feed_sorted_by": "Alimentación ordenadas según",
    "form.prefs.label.feed_direction": "La dirección de alimentación de clasificación",
    "form.prefs.select.feed_sorted_by_disabled": "Discapacitado",
    "form.prefs.select.feed_sorted_by_error": "La cuenta de errores",
    "form.prefs.select.feed_sorted_by_title": "Título",
    "form.prefs.select.feed_sorted_by_total_count": "Entradas totales",
    "form.prefs.select.feed_sorted_by_unread_count": "entradas sin leer",
    "form.prefs.select.feed_direction_asc": "ascendente",
    "form.prefs.select.feed_direction_desc": "descendente",
    ...
    "menu.sort_feeds_sort": "Trier par",
    "menu.sort_feeds_disabled": "Désactivé",
    "menu.sort_feeds_errors": "Erreurs",
    "menu.sort_feeds_title": "Titre",
    "menu.sort_feeds_total": "Total",
    "menu.sort_feeds_unread": "Non lus",
    ...
    "form.prefs.label.feed_sorted_by": "Alimentation trié par",
    "form.prefs.label.feed_direction": "Parasites direction de tri",
    "form.prefs.select.feed_sorted_by_disabled": "Désactivé",
    "form.prefs.select.feed_sorted_by_error": "Nombre d'erreurs",
    "form.prefs.select.feed_sorted_by_title": "Titre",
    "form.prefs.select.feed_sorted_by_total_count": "Entrées totales",
    "form.prefs.select.feed_sorted_by_unread_count": "Entrées non lues",
    "form.prefs.select.feed_direction_asc": "Ascendant",
    "form.prefs.select.feed_direction_desc": "Descendant",
    ...
    "menu.sort_feeds_sort": "Ordina per",
    "menu.sort_feeds_disabled": "Disabilitato",
    "menu.sort_feeds_errors": "Errori",
    "menu.sort_feeds_title": "Titolo",
    "menu.sort_feeds_total": "Totale",
    "menu.sort_feeds_unread": "Non letto",
    "search.label": "Cerca",
    ...
    "form.prefs.label.feed_sorted_by": "Alimentazione allineati secondo",
    "form.prefs.label.feed_direction": "Verso di scansione feed",
    "form.prefs.select.feed_sorted_by_disabled": "Disabilitato",
    "form.prefs.select.feed_sorted_by_error": "Conteggio degli errori",
    "form.prefs.select.feed_sorted_by_title": "Titolo",
    "form.prefs.select.feed_sorted_by_total_count": "Voci totali",
    "form.prefs.select.feed_sorted_by_unread_count": "Voci non lette",
    "form.prefs.select.feed_direction_asc": "Ascendente",
    "form.prefs.select.feed_direction_desc": "Discendente",
    ...
    "menu.sort_feeds_sort": "並べ替え",
    "menu.sort_feeds_disabled": "無効",
    "menu.sort_feeds_errors": "エラー",
    "menu.sort_feeds_title": "題名",
    "menu.sort_feeds_total": "トータル",
    "menu.sort_feeds_unread": "未読",
    "search.label": "検索",
    ...
    "form.prefs.label.feed_sorted_by": "並べ替えフィード",
    "form.prefs.label.feed_direction": "フィードのソート方向",
    "form.prefs.select.feed_sorted_by_disabled": "無効",
    "form.prefs.select.feed_sorted_by_error": "エラーカウント",
    "form.prefs.select.feed_sorted_by_title": "題名",
    "form.prefs.select.feed_sorted_by_total_count": "合計エントリ",
    "form.prefs.select.feed_sorted_by_unread_count": "未読のエントリー",
    "form.prefs.select.feed_direction_asc": "昇順",
    "form.prefs.select.feed_direction_desc": "降順",
    ...
    "menu.sort_feeds_sort": "Gesorteerd op",
    "menu.sort_feeds_disabled": "Gehandicapt",
    "menu.sort_feeds_errors": "Fouten",
    "menu.sort_feeds_title": "Titel",
    "menu.sort_feeds_total": "Totaal",
    "menu.sort_feeds_unread": "Ongelezen",
    "search.label": "Zoeken",
    ...
    "form.prefs.label.feed_sorted_by": "Feed gesorteerd op",
    "form.prefs.label.feed_direction": "Feed sorteerrichting",
    "form.prefs.select.feed_sorted_by_disabled": "Gehandicapt",
    "form.prefs.select.feed_sorted_by_error": "Aantal fouten",
    "form.prefs.select.feed_sorted_by_title": "Titel",
    "form.prefs.select.feed_sorted_by_total_count": "Totale inzendingen",
    "form.prefs.select.feed_sorted_by_unread_count": "Ongelezen vermeldingen",
    "form.prefs.select.feed_direction_asc": "Oplopend",
    "form.prefs.select.feed_direction_desc": "Aflopend",
    ...
    "menu.sort_feeds_sort": "Klasyfikowane według",
    "menu.sort_feeds_disabled": "Wyłączone",
    "menu.sort_feeds_errors": "Błędy",
    "menu.sort_feeds_title": "Tytuł",
    "menu.sort_feeds_total": "Całkowity",
    "menu.sort_feeds_unread": "Nieprzeczytane",
    "search.label": "Szukaj",
    ...
    "form.prefs.label.feed_sorted_by": "Kanał klasyfikowane według",
    "form.prefs.label.feed_direction": "Karmić kierunek sortowania",
    "form.prefs.select.feed_sorted_by_disabled": "Wyłączone",
    "form.prefs.select.feed_sorted_by_error": "Licznik błędów",
    "form.prefs.select.feed_sorted_by_title": "Tytuł",
    "form.prefs.select.feed_sorted_by_total_count": "Całkowite wpisy",
    "form.prefs.select.feed_sorted_by_unread_count": "Nieprzeczytane wpisy",
    "form.prefs.select.feed_direction_asc": "Rosnąco",
    "form.prefs.select.feed_direction_desc": "Malejąco",
    ...
    "menu.sort_feeds_sort": "Classificado por",
    "menu.sort_feeds_disabled": "Desativado",
    "menu.sort_feeds_errors": "Erros",
    "menu.sort_feeds_title": "Título",
    "menu.sort_feeds_total": "Total",
    "menu.sort_feeds_unread": "Não lida",
    "search.label": "Buscar",
    ...
    "form.prefs.label.feed_sorted_by": "Alimentação classificado por",
    "form.prefs.label.feed_direction": "Direcção da ordenação de alimentação",
    "form.prefs.select.feed_sorted_by_disabled": "Desativado",
    "form.prefs.select.feed_sorted_by_error": "Contagem de erro",
    "form.prefs.select.feed_sorted_by_title": "Título",
    "form.prefs.select.feed_sorted_by_total_count": "Entradas totais",
    "form.prefs.select.feed_sorted_by_unread_count": "Entradas não lidas",
    "form.prefs.select.feed_direction_asc": "Crescente",
    "form.prefs.select.feed_direction_desc": "Descendente",
    ...
    "menu.sort_feeds_sort": "Отсортировано по",
    "menu.sort_feeds_disabled": "Отключено",
    "menu.sort_feeds_errors": "Ошибки",
    "menu.sort_feeds_title": "заглавие",
    "menu.sort_feeds_total": "Всего",
    "menu.sort_feeds_unread": "Непрочитанный",
    "search.label": "Поиск",
    ...
    "form.prefs.label.feed_sorted_by": "Лента отсортировано по",
    "form.prefs.label.feed_direction": "Направление подачи сортировки",
    "form.prefs.select.feed_sorted_by_disabled": "Отключено",
    "form.prefs.select.feed_sorted_by_error": "Количество ошибок",
    "form.prefs.select.feed_sorted_by_title": "заглавие",
    "form.prefs.select.feed_sorted_by_total_count": "Всего записей",
    "form.prefs.select.feed_sorted_by_unread_count": "Непрочитанные записи",
    "form.prefs.select.feed_direction_asc": "Восходящий",
    "form.prefs.select.feed_direction_desc": "По убыванию",
    ...
    "menu.sort_feeds_sort": "排序",
    "menu.sort_feeds_disabled": "禁用",
    "menu.sort_feeds_errors": "错误",
    "menu.sort_feeds_title": "标题",
    "menu.sort_feeds_total": "总数",
    "menu.sort_feeds_unread": "未读",
    "search.label": "搜索",
    ...
    "form.prefs.label.feed_sorted_by": "订阅排序为",
    "form.prefs.label.feed_direction": "订阅排序方向",
    "form.prefs.select.feed_sorted_by_disabled": "禁用",
    "form.prefs.select.feed_sorted_by_error": "错误计数",
    "form.prefs.select.feed_sorted_by_title": "标题",
    "form.prefs.select.feed_sorted_by_total_count": "总条目",
    "form.prefs.select.feed_sorted_by_unread_count": "未读条目",
    "form.prefs.select.feed_direction_asc": "升序",
    "form.prefs.select.feed_direction_desc": "降序",
...
var translationsChecksums = map[string]string{
	"de_DE": "069355de9b706ad9912c1adf3d2ea3099d4a4b8d5e57c606c28e74f15e287948",
	"en_US": "a8665ad1cc1f901d0fb1c40778a61422a977af49f0ef8ef70648b492bdb751e3",
	"es_ES": "b3ebeff505848218ff720600627441ec91987cad54aeecd00cc7c90ace67ee3e",
	"fr_FR": "d6c9e5dad83afd973978e8167fecbc679633a36ee546773f417fe7c0cf622c72",
	"it_IT": "1d155ec2a6e2d71dc7b7a758876ea84d8c94452f929abdacf8be68bab7d4063a",
	"ja_JP": "61405679d664ca8a9ee8f45f64c16a78ae1520465389fb69a6ac92d3acd024da",
	"nl_NL": "e030df06b91d1e184d54510907a6a03ba0d1f461ae321dae0a23c0d746750a37",
	"pl_PL": "41a47dd2930c72eaf1e8325baf266f5566e6721853d9fda18045679b37988f55",
	"pt_BR": "99dec1eefc61f1334cbe8f5ef1a5e3d511608c19248ab718fc75040fb0473a86",
	"ru_RU": "2dc7e2c8bd68e33f4454fb61dc5bb53ac59030663bfc57588e322caa4995553a",
	"zh_CN": "9320ed29d4b8b2558a8e4a7e65c6a46c241663f522e5f63b7b75bce1c66a9095",
}
