...
function findEntry(element){if(isListView()){if(element)
return DomHelper.findParent(element,"item");else
return document.querySelector(".current-item");}else{return document.querySelector(".entry");}}
...
var JavascriptsChecksums = map[string]string{
	"app": "5db6c43b16f684703417587c2f4dd992fd698e4a825cde84f4bba5541436c8e0",
