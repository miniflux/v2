...
function goUp(){if(isListView()){goToPreviousListItem();}else{window.scrollTo(window.scrollX,window.scrollY-20);}}
function goDown(){if(isListView()){goToNextListItem();}else{window.scrollTo(window.scrollX,window.scrollY+20);}}
...
var JavascriptsChecksums = map[string]string{
	"app": "86b189c5008dd21a1301ec84ad407cee7fce94266ae657face7bf97835892b47",
