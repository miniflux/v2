...
class AppearHandler{constructor(selector,opts={"onappear":function(e){},"ondisappear":function(e){}}){this.selectors=[];this.checkBinded=false;this.checkLock=false;this.defaults={interval:250,force_process:false};this.priorAppeared=[];if(typeof(selector)!="undefined"){this.addSelector(selector,opts)}
...
var JavascriptsChecksums = map[string]string{
	"app": "adc178f297782ba4af6113b591d5c576f78eaf00af84f8cce6e1a4c7a1d30f31",
