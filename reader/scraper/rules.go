...
var predefinedRules = map[string]string{
	...
	"golem.de":            "div.formatted p, header.cluster-header p, figure.hero img",
	"heise.de":            "header .article-content__lead, header .article-image, div.article-layout__content.article-content",
	"heide.de/tp":         "article.akwa-article p, figure.aufmacherbild",
	...
	"tagesschau.de":       "p.small, div.media.mediaA",
	"tagesspiegel.de":     "div.ts-article-body p, div.ts-media",
