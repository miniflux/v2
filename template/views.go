...
// 2018-05-19 19:43:44.800592293 -0700 PDT m=+0.004262692
...
<form method="post" autocomplete="off" action="{{ route "updateIntegration" }}">
    ...
    <div class="form-section">
        ...
        (<a href="https://www.jamesfmackenzie.com/getting-started-with-the-pocket-developer-api/">{{ t "How To" }}</a>)
        ...
        (<a href="https://getpocket.com/developer/apps/new">{{ t "Create" }}</a>)
    </div>
...
var templateViewsMapChecksums = map[string]string{
	...
	"integrations":        "307fa2feb06c3328a2d899633838d44bc84af97638c226fd734afbb6a1157226",
