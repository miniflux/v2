        ...
        <article class="item {{ if ne .ParsingErrorCount 0 }}feed-parsing-error{{ end }}">
            ...
            <div class="item-meta">
                <ul>
                    ...
                    {{ if gt (index $.feedCountUnread .ID) 0 }}
                    <li>
                        {{ t "page.feeds.unread" }} <span class="unread-counter">{{ index $.feedCountUnread .ID }}</span>
                    </li>
                    {{ end }}
                </ul>
                <ul>
...
var templateViewsMapChecksums = map[string]string{
	...
	"feeds":               "0f0d7b21bf657c5bf2444b7210755fa3f20299fe0ce35d86f49bad1906e7420e",
